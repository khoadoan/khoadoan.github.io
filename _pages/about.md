...
[[more about our research](research)] [[SAIL Research](https://sail-research.com/) <i class="fa fa-external-link" aria-hidden="true"></i>] [<a href="#open-office-hour-calendar">open office hour</a> 
  <i class="fa fa-calendar" aria-hidden="true"></i>]
...
<!-- **Center for Environmental Intelligence** ([CEI](https://cei.vinuni.edu.vn/)) -- *MAIL-Research is a member of CEI*. Please reach out via [[email](mailto:khoa.dd@vinuni.edu.vn)] for collaboration on *environmental monitoring*. [[more about CEI](research/#CEI)]. -->
